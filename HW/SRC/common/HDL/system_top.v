...
// ========================================================================================================
	...
	GPS_Monit Inst_GPS_Monit 
		(
			.clk(AD_clk), 
			.probe0(GPS_rx_loop_back),
			.probe1(GPS_tx_loop_back)
		);
	...
	i_iobuf_gpio 
		(
			...
			.dio_p ({ gpio_muxout_tx, gpio_muxout_rx, gpio_resetb, gpio_sync, gpio_en_agc, gpio_ctl, gpio_status, gpio_bd})
		);
