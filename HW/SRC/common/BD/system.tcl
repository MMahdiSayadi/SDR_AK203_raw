...
proc create_hier_cell_AD9361 { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 15 -to 0 adc_data_i0
  create_bd_pin -dir O -from 15 -to 0 adc_data_i1
  create_bd_pin -dir O -from 15 -to 0 adc_data_q0
  create_bd_pin -dir O -from 15 -to 0 adc_data_q1
  create_bd_pin -dir O -type clk clk_out
  create_bd_pin -dir I -from 15 -to 0 dac_data_i0
  create_bd_pin -dir I -from 15 -to 0 dac_data_i1
  create_bd_pin -dir I -from 15 -to 0 dac_data_q0
  create_bd_pin -dir I -from 15 -to 0 dac_data_q1
  ...
  create_bd_pin -dir I tdd_sync_i
  create_bd_pin -dir O tdd_sync_o
  create_bd_pin -dir O tdd_sync_t
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {61380000} \
 ] [get_bd_pins /AD9361/util_ad9361_divclk/clk_out]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_cpu_interconnect/S00_AXI]
  ...
  connect_bd_net -net axi_ad9361_adc_data_i0 [get_bd_pins adc_data_i0] [get_bd_pins axi_ad9361/adc_data_i0]
  connect_bd_net -net axi_ad9361_adc_data_i1 [get_bd_pins adc_data_i1] [get_bd_pins axi_ad9361/adc_data_i1]
  connect_bd_net -net axi_ad9361_adc_data_q0 [get_bd_pins adc_data_q0] [get_bd_pins axi_ad9361/adc_data_q0]
  connect_bd_net -net axi_ad9361_adc_data_q1 [get_bd_pins adc_data_q1] [get_bd_pins axi_ad9361/adc_data_q1]
  ...
  connect_bd_net -net axi_ad9361_enable [get_bd_pins enable] [get_bd_pins axi_ad9361/enable]
  connect_bd_net -net axi_ad9361_l_clk [get_bd_pins axi_ad9361/clk] [get_bd_pins axi_ad9361/l_clk] [get_bd_pins fifo_generator_0/rd_clk] [get_bd_pins fifo_generator_1/rd_clk] [get_bd_pins fifo_generator_2/rd_clk] [get_bd_pins fifo_generator_3/rd_clk] [get_bd_pins util_ad9361_divclk/clk]
  connect_bd_net -net axi_ad9361_tdd_sync_cntr [get_bd_pins tdd_sync_t] [get_bd_pins axi_ad9361/tdd_sync_cntr] [get_bd_pins util_ad9361_tdd_sync/sync_mode]
  ...
  connect_bd_net -net axi_ad9361_txnrx [get_bd_pins txnrx] [get_bd_pins axi_ad9361/txnrx]
  connect_bd_net -net dac_data_i0_1 [get_bd_pins dac_data_i0] [get_bd_pins fifo_generator_0/din]
  connect_bd_net -net dac_data_i1_1 [get_bd_pins dac_data_i1] [get_bd_pins fifo_generator_2/din]
  connect_bd_net -net dac_data_q0_1 [get_bd_pins dac_data_q0] [get_bd_pins fifo_generator_1/din]
  connect_bd_net -net dac_data_q1_1 [get_bd_pins dac_data_q1] [get_bd_pins fifo_generator_3/din]
  connect_bd_net -net fifo_generator_0_dout [get_bd_pins axi_ad9361/dac_data_i0] [get_bd_pins fifo_generator_0/dout]
  connect_bd_net -net fifo_generator_1_dout [get_bd_pins axi_ad9361/dac_data_q0] [get_bd_pins fifo_generator_1/dout]
  connect_bd_net -net fifo_generator_2_dout [get_bd_pins axi_ad9361/dac_data_i1] [get_bd_pins fifo_generator_2/dout]
  connect_bd_net -net fifo_generator_3_dout [get_bd_pins axi_ad9361/dac_data_q1] [get_bd_pins fifo_generator_3/dout]
  ...
  connect_bd_net -net sys_200m_clk [get_bd_pins delay_clk] [get_bd_pins axi_ad9361/delay_clk]
  connect_bd_net -net sys_cpu_clk [get_bd_pins s_axi_aclk] [get_bd_pins axi_ad9361/s_axi_aclk] [get_bd_pins axi_cpu_interconnect/ACLK] [get_bd_pins axi_cpu_interconnect/M00_ACLK] [get_bd_pins axi_cpu_interconnect/S00_ACLK] [get_bd_pins util_ad9361_tdd_sync/clk]
  connect_bd_net -net sys_cpu_resetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_ad9361/s_axi_aresetn] [get_bd_pins axi_cpu_interconnect/ARESETN] [get_bd_pins axi_cpu_interconnect/M00_ARESETN] [get_bd_pins axi_cpu_interconnect/S00_ARESETN] [get_bd_pins util_ad9361_tdd_sync/rstn]
  connect_bd_net -net tdd_sync_i_1 [get_bd_pins tdd_sync_i] [get_bd_pins util_ad9361_tdd_sync/sync_in]
  connect_bd_net -net up_enable_1 [get_bd_pins up_enable] [get_bd_pins axi_ad9361/up_enable]
  connect_bd_net -net up_txnrx_1 [get_bd_pins up_txnrx] [get_bd_pins axi_ad9361/up_txnrx]
  connect_bd_net -net util_ad9361_divclk_clk_out [get_bd_pins clk_out] [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins fifo_generator_1/wr_clk] [get_bd_pins fifo_generator_2/wr_clk] [get_bd_pins fifo_generator_3/wr_clk] [get_bd_pins util_ad9361_divclk/clk_out]
  ...
  connect_bd_net -net util_ad9361_tdd_sync_sync_out [get_bd_pins tdd_sync_o] [get_bd_pins axi_ad9361/tdd_sync] [get_bd_pins util_ad9361_tdd_sync/sync_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins fifo_generator_0/rd_en] [get_bd_pins fifo_generator_0/wr_en] [get_bd_pins fifo_generator_1/rd_en] [get_bd_pins fifo_generator_1/wr_en] [get_bd_pins fifo_generator_2/rd_en] [get_bd_pins fifo_generator_2/wr_en] [get_bd_pins fifo_generator_3/rd_en] [get_bd_pins fifo_generator_3/wr_en] [get_bd_pins xlconstant_0/dout]
...
proc create_root_design { parentCell } {
  ...
  set eth_gtx_Clk [ create_bd_port -dir O -type clk eth_gtx_Clk ]
  set eth_rx_dv [ create_bd_port -dir I eth_rx_dv ]
  ...
  set eth_tx_enable [ create_bd_port -dir O eth_tx_enable ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#USB Reset#GPIO#GPIO#GPIO#GPIO#GPIO} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#tx#rx#gpio[14]#gpio[15]#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#gpio[47]#reset#gpio[49]#gpio[50]#gpio[51]#gpio[52]#gpio[53]} \
  ...
  connect_bd_intf_net -intf_net sys_ps7_M_AXI_GP0 [get_bd_intf_pins AD9361/S00_AXI] [get_bd_intf_pins sys_ps7/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net AD9361_adc_data_i0 [get_bd_pins AD9361/adc_data_i0] [get_bd_pins ila_0/probe0]
  connect_bd_net -net AD9361_adc_data_i1 [get_bd_pins AD9361/adc_data_i1] [get_bd_pins ila_0/probe1]
  connect_bd_net -net AD9361_adc_data_q0 [get_bd_pins AD9361/adc_data_q0] [get_bd_pins ila_0/probe2]
  connect_bd_net -net AD9361_adc_data_q1 [get_bd_pins AD9361/adc_data_q1] [get_bd_pins ila_0/probe3]
  connect_bd_net -net axi_ad9361_enable [get_bd_ports enable] [get_bd_pins AD9361/enable]
  connect_bd_net -net axi_ad9361_tdd_sync_cntr [get_bd_ports tdd_sync_t] [get_bd_pins AD9361/tdd_sync_t]
  ...
  connect_bd_net -net axi_ad9361_txnrx [get_bd_ports txnrx] [get_bd_pins AD9361/txnrx]
  connect_bd_net -net clk_61_38_1 [get_bd_ports clk_out] [get_bd_pins AD9361/clk_out] [get_bd_pins ila_0/clk]
  ...
  connect_bd_net -net sys_200m_clk [get_bd_pins AD9361/delay_clk] [get_bd_pins sys_ps7/FCLK_CLK1]
  connect_bd_net -net sys_cpu_clk [get_bd_pins AD9361/s_axi_aclk] [get_bd_pins sys_ps7/FCLK_CLK0] [get_bd_pins sys_ps7/M_AXI_GP0_ACLK] [get_bd_pins sys_rstgen/slowest_sync_clk]
  connect_bd_net -net sys_cpu_resetn [get_bd_pins AD9361/s_axi_aresetn] [get_bd_pins sys_rstgen/peripheral_aresetn]
  ...
  connect_bd_net -net tdd_sync_i_1 [get_bd_ports tdd_sync_i] [get_bd_pins AD9361/tdd_sync_i]
  connect_bd_net -net up_enable_1 [get_bd_ports up_enable] [get_bd_pins AD9361/up_enable]
  connect_bd_net -net up_txnrx_1 [get_bd_ports up_txnrx] [get_bd_pins AD9361/up_txnrx]
  connect_bd_net -net util_ad9361_tdd_sync_sync_out [get_bd_ports tdd_sync_o] [get_bd_pins AD9361/tdd_sync_o]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs AD9361/axi_ad9361/s_axi/axi_lite] SEG_axi_ad9361_axi_lite
